...
contract ContributorNFTFactory is IFactory {
    ...
    /**
     * @notice Deploys a ContributorNFT contract.
     *
    ...
    function deploy(
        ...
        nft = address(new ContributorNFT(_name, _symbol, _baseTokenURI, _daoAdmins, _minterAllowerAddr, _allowTransfers));
    }
